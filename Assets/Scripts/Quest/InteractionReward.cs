...
// public class InteractionReward : MonoBehaviour, IQuizHandler, IQuestIconHandler
// {
//     [Header("상호작용 설정")]
...
//     void Start()
//     {
//         if (showQuestIcon && QuestManager.Instance != null && QuestManager.Instance.iconPrefab != null)
//         {
...
//         isProcessing = true;
//         // DialogueManager의 ShowQuiz를 호출 (나 자신(this)을 전달하여 OnAnswer가 호출되게 함)
...
//         if (!showQuestIcon) { iconRenderer.gameObject.SetActive(false); return; }
...
//             // 성공 메시지 출력 ({item} 이라는 문구가 있으면 아이템 이름으로 치환해주는 기능 추가)
